...
class AppColors {
  static final Color green = Color(0xff04D361);
  static final Color red = Color(0xffF44336);
  static final Color blue = Color(0xff57B6E5);
  static final Color lightRed = Color(0xffF5E9EC);
  static final Color lightGreen = Color(0xffE1F5EC);
  static final Color grey = Color(0xffF8F4F4);
  static final Color cancelButtonColor = Color(0xffECF3EF);
  static final Color cancelTextColor = Color(0xffACA8A8);
  ...
  static final Color levelButtonBorderMedio = Color(0xFFB8DBCB);
  static final Color levelButtonBorderDificil = Color(0xFFE5D5C5);
  static final Color levelButtonBorderPerito = Color(0xFFE5C5CF);
  ...
  static final Color levelButtonNotSelected = Color(0xFFCFCFCF);
  static final Color levelButtonBorderNotSelected = Color(0xFF707070);
  static final Color levelButtonTextNotSelected = Color(0xFF6F6E6E);
}
